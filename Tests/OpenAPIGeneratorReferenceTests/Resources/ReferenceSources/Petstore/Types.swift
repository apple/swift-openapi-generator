...
public enum Components {
    ...
    public enum Schemas {
        ...
        @frozen
        public enum PetKind: RawRepresentable, Codable, Hashable, Sendable, _AutoLosslessStringConvertible, CaseIterable
        {
            case cat
            case dog
            case ELEPHANT
        ...
        public struct PetFeeding: Codable, Hashable, Sendable {
            ...
            @frozen
            public enum schedulePayload: RawRepresentable, Codable, Hashable, Sendable, _AutoLosslessStringConvertible,
                CaseIterable
            {
                case hourly
                case daily
