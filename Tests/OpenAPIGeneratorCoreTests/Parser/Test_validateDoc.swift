...
final class Test_validateDoc: Test_Core {
    ...
    func testSchemaWarningIsNotFatal() throws {
        ...
        let diagnostics = try validateDoc(doc, config: .init(mode: .types, featureFlags: [.strictOpenAPIValidation]))
    ...
    func testStructuralWarningIsFatal() throws {
        ...
        XCTAssertThrowsError(
            try validateDoc(doc, config: .init(mode: .types, featureFlags: [.strictOpenAPIValidation]))
        )
    }
