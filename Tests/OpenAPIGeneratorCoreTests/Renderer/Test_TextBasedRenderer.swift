...
final class Test_TextBasedRenderer: XCTestCase {
    ...
    func testImports() throws {
        try _test(nil, renderedBy: renderer.renderedImports, rendersAs: "")
        try _test(
    ...
    func testExpression() throws {
        ...
        try _test(
            .memberAccess(.init(left: .identifier("foo"), right: "bar")),
            renderedBy: renderer.renderedExpression,
            rendersAs: #"""
                foo.bar
                """#
        ...
        try _test(
            .functionCall(
                .init(
                    ...
                    arguments: [.init(label: nil, expression: .identifier("foo"))]
                )
            ),
            renderedBy: renderer.renderedExpression,
            rendersAs: #"""
    ...
    func testParameter() throws {
        try _test(
            .init(label: "l", name: "n", type: "T", defaultValue: .literal(.nil)),
        ...
        try _test(
            .init(label: nil, name: "n", type: "T", defaultValue: .literal(.nil)),
            renderedBy: renderer.renderedParameter,
            rendersAs: #"""
                _ n : T = nil
                """#,
        ...
        try _test(
            .init(label: "l", name: nil, type: "T", defaultValue: .literal(.nil)),
            renderedBy: renderer.renderedParameter,
            rendersAs: #"""
                l : T = nil
                """#,
        ...
        try _test(
            .init(label: nil, name: nil, type: "T", defaultValue: .literal(.nil)),
            renderedBy: renderer.renderedParameter,
            rendersAs: #"""
                _ : T = nil
                """#,
        ...
        try _test(
            .init(label: nil, name: nil, type: "T", defaultValue: nil),
            renderedBy: renderer.renderedParameter,
            rendersAs: #"""
                _ : T
                """#,
    ...
    func testFunction() throws {
        ...
        try _test(
            .init(
                ...
                parameters: [.init(label: "a", name: "b", type: "C", defaultValue: nil)],
                body: []
            ),
            renderedBy: renderer.renderedFunction,
            rendersAs: #"""
        ...
        try _test(
            .init(
                ...
                kind: .function(name: "f"),
                parameters: [
                    .init(label: "a", name: "b", type: "C", defaultValue: nil),
                    .init(label: nil, name: "d", type: "E", defaultValue: .literal(.string("f"))),
                ],
                body: []
            ),
            renderedBy: renderer.renderedFunction,
        ...
        try _test(
            .init(kind: .function(name: "f"), parameters: [], keywords: [.async, .throws], returnType: "String"),
            renderedBy: renderer.renderedFunction,
            rendersAs: #"""
    ...
    func testFunctionCallArgument() throws {
        try _test(
            .init(label: "foo", expression: .identifier("bar")),
        ...
        try _test(
            .init(label: nil, expression: .identifier("bar")),
            renderedBy: renderer.renderedFunctionCallArgument,
            rendersAs: #"""
                bar
                """#
    ...
    func testFunctionCall() throws {
        try _test(
            .functionCall(.init(calledExpression: .identifier("callee"))),
            renderedBy: renderer.renderedExpression,
            rendersAs: #"""
                callee()
                """#
        ...
        try _test(
            .functionCall(
                .init(
                    calledExpression: .identifier("callee"),
                    arguments: [.init(label: "foo", expression: .identifier("bar"))]
                )
            ),
            renderedBy: renderer.renderedExpression,
            rendersAs: #"""
        ...
        try _test(
            .functionCall(
                .init(
                    ...
                    arguments: [
                        .init(label: "foo", expression: .identifier("bar")),
                        .init(label: "baz", expression: .identifier("boo")),
                    ]
                )
            ),
            renderedBy: renderer.renderedExpression,
    ...
    func testExtension() throws {
        try _test(
            .init(
                accessModifier: .public,
                onType: "Info",
                declarations: [.variable(.init(kind: .let, left: "foo", type: "Int"))]
            ),
    ...
    func testTypealias() throws {
        try _test(
            .init(name: "inty", existingType: "Int"),
        ...
        try _test(
            .init(accessModifier: .private, name: "inty", existingType: "Int"),
            renderedBy: renderer.renderedTypealias,
            rendersAs: #"""
    ...
    func testFile() throws {
        try _test(
            .init(
                ...
                codeBlocks: [.init(comment: nil, item: .expression(.literal(.nil)))]
            ),
...
extension Test_TextBasedRenderer {
    func _test<Input>(
        ...
        if normalizing {
            XCTAssertEqual(try renderer(input).swiftFormatted, try output.swiftFormatted, file: file, line: line)
        } else {
            XCTAssertEqual(renderer(input), output, file: file, line: line)
        }
    }
}
