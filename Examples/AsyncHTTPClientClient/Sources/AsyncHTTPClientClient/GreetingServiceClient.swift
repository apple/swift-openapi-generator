...
@main struct GreetingServiceClient {
    ...
    static func main() async throws {
        ...
        // TODO: Remove the explicit configuration parameter once https://github.com/swift-server/swift-openapi-async-http-client/pull/32
        // lands and is released.
        let transport: some ClientTransport = AsyncHTTPClientTransport(configuration: .init())
