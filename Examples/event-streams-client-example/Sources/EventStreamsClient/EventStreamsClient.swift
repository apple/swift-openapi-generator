...
@main struct EventStreamsClient {
    static func main() async throws {
        ...
        do {
            ...
            let greetingStream = try response
                .ok
                .body
                .application_jsonl
                .asDecodedJSONLines(of: Components.Schemas.Greeting.self)
        ...
        do {
            ...
            let greetingStream = try response
                ...
                .asDecodedJSONSequence(of: Components.Schemas.Greeting.self)
            for try await greeting in greetingStream {
                print("Got greeting: \(greeting.message)")
            }
        }
        do {
            ...
            for try await greeting in greetingStream {
                print("Got greeting: \(greeting.data?.message ?? "<nil>")")
            }
        }
    }
}
