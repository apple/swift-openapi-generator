...
/* nested in Operations.uploadPhoto.Input */ {
    enum Body {
        enum multipartFormPayload: MultipartPartProtocol {
            ...
            case contents(MultipartTypedPartWrapper<contentsPayload>)
...
for try await part in multipartBody {
    switch part {
    case .metadata(let metadataWrapper):
    ...
    case .contents(let contentsWrapper):
        ...
        for try await chunk in contentsWrapper.body {
