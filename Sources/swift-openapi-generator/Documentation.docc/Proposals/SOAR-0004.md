...
extension HTTPBody {
    ...
    @inlinable public convenience init<S>(byteChunks: S, length: Length, iterationBehavior: IterationBehavior) where S : Sendable, S : Sequence, S.Element == ArraySlice<UInt8>

    /// Creates a new body with the provided collection of byte chunks.
    /// - Parameters:
    ///   - byteChunks: A collection of byte chunks.
    ///   - length: The total length of the body.
    @inlinable public convenience init<C>(byteChunks: C, length: Length) where C : Collection, C : Sendable, C.Element == ArraySlice<UInt8>

    /// Creates a new body with the provided collection of byte chunks.
    ///   - byteChunks: A collection of byte chunks.
    @inlinable public convenience init<C>(byteChunks: C) where C : Collection, C : Sendable, C.Element == ArraySlice<UInt8>
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S>(sequence: S, length: HTTPBody.Length, iterationBehavior: IterationBehavior) where S : Sendable, S : AsyncSequence, S.Element == ArraySlice<UInt8>
}
...
extension HTTPBody {
    ...
    ///   - length: The total length of the body.
    @inlinable public convenience init<S>(string: S, length: Length) where S : Sendable, S : StringProtocol

    /// Creates a new body with the provided string encoded as UTF-8 bytes.
    /// - Parameters:
    ///   - string: A string to encode as bytes.
    @inlinable public convenience init<S>(string: S) where S : Sendable, S : StringProtocol
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S>(stringChunks: S, length: Length, iterationBehavior: IterationBehavior) where S : Sendable, S : Sequence, S.Element : StringProtocol

    /// Creates a new body with the provided strings encoded as UTF-8 bytes.
    /// - Parameters:
    ///   - stringChunks: A collection of string chunks.
    ///   - length: The total length of the body.
    @inlinable public convenience init<C>(stringChunks: C, length: Length) where C : Collection, C : Sendable, C.Element : StringProtocol

    /// Creates a new body with the provided strings encoded as UTF-8 bytes.
    /// - Parameters:
    ///   - stringChunks: A collection of string chunks.
    @inlinable public convenience init<C>(stringChunks: C) where C : Collection, C : Sendable, C.Element : StringProtocol
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S>(sequence: S, length: HTTPBody.Length, iterationBehavior: IterationBehavior) where S : Sendable, S : AsyncSequence, S.Element : StringProtocol
}
