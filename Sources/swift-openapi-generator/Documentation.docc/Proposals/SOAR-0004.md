...
public final class HTTPBody : @unchecked Sendable {
    ...
    @usableFromInline
    convenience internal init<S>(_ byteChunks: S, length: Length, iterationBehavior: IterationBehavior) where S : Sendable, S : Sequence, S.Element == ArraySlice<UInt8>
}
...
extension HTTPBody {
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S>(_ bytes: S, length: Length, iterationBehavior: IterationBehavior) where S : Sendable, S : Sequence, S.Element == UInt8

    /// Creates a new body with the provided byte collection.
    /// - Parameters:
    ///   - bytes: A byte chunk.
    ///   - length: The total length of the body.
    @inlinable public convenience init<C>(_ bytes: C, length: Length) where C : Collection, C : Sendable, C.Element == UInt8

    /// Creates a new body with the provided byte collection.
    /// - Parameters:
    ///   - bytes: A byte chunk.
    @inlinable public convenience init<C>(_ bytes: C) where C : Collection, C : Sendable, C.Element == UInt8
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S>(_ sequence: S, length: HTTPBody.Length, iterationBehavior: IterationBehavior) where S : Sendable, S : AsyncSequence, S.Element == ArraySlice<UInt8>
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S, ES>(_ sequence: S, length: HTTPBody.Length, iterationBehavior: IterationBehavior) where S : Sendable, S : AsyncSequence, ES : Sequence, ES == S.Element, ES.Element == UInt8
}
...
extension HTTPBody {
    ...
    ///   - length: The total length of the body.
    @inlinable public convenience init<S>(_ string: S, length: Length) where S : Sendable, S : StringProtocol

    /// Creates a new body with the provided string encoded as UTF-8 bytes.
    /// - Parameters:
    ///   - string: A string to encode as bytes.
    @inlinable public convenience init<S>(_ string: S) where S : Sendable, S : StringProtocol
    ...
    ///   - length: The total length of the body.
    @inlinable public convenience init(_ stream: AsyncThrowingStream<some StringProtocol, any Error>, length: HTTPBody.Length)

    /// Creates a new body with the provided async stream of strings.
    /// - Parameters:
    ///   - stream: An async stream that provides the string chunks.
    ///   - length: The total length of the body.
    @inlinable public convenience init(_ stream: AsyncStream<some StringProtocol>, length: HTTPBody.Length)
    ...
    ///   - iterationBehavior: The iteration behavior of the sequence, which
    ///     indicates whether it can be iterated multiple times.
    @inlinable public convenience init<S>(_ sequence: S, length: HTTPBody.Length, iterationBehavior: IterationBehavior) where S : Sendable, S : AsyncSequence, S.Element : StringProtocol
}
...
extension HTTPBody.ByteChunk where Element == UInt8 {
    ...
    @inlinable internal init<S>(_ string: S) where S : Sendable, S : StringProtocol
}
...
extension HTTPBody {
    ...
    internal struct BodySequence : AsyncSequence, Sendable {
        ...
        @inlinable internal init<S>(_ sequence: S) where S : Sendable, S : AsyncSequence, S.Element == ArraySlice<UInt8>
    ...
    @usableFromInline
    internal struct WrappedSyncSequence<S> : AsyncSequence, Sendable where S : Sendable, S : Sequence, S.Element == ArraySlice<UInt8> {
