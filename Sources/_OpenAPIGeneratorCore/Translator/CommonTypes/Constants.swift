...
enum Constants {
    ...
    enum File {
        ...
        static let imports: [ImportStatement] = [
            .always(ImportDescription(moduleName: Constants.Import.runtime, spi: "Generated")),
            .conditional(
        ...
        static let clientServerImports: [ImportStatement] =
            imports + [.always(ImportDescription(moduleName: Constants.Import.httpTypes, setsAccessModifier: false))]
    }
